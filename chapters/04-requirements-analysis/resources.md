...
- 📘 **DSDM / Agile Business Consortium — MoSCoW Prioritisation.** The source framework that
  ...
  <https://www.agilebusiness.org/dsdm-project-framework/moscow-prioritision.html>
...
- 📄 **Kano et al. (1984) — "Attractive Quality and Must-Be Quality."** The original paper
  introducing the model (in the *Journal of the Japanese Society for Quality Control*).
  Frequently summarized in open courseware; search your library for the translated reprint.
  *Original is copyrighted; the Wikipedia article (CC BY-SA) is a fair open starting point:*
...
- 📄 **Boehm et al. — "Cost Models for Future Software Life Cycle Processes: COCOMO 2.0"**
  ...
  the power-law form and scale/effort factors.
  <http://csse.usc.edu/TECHRPTS/1995/usccse95-500/usccse95-500.pdf>
  *Free to download from USC CSSE.*

- 🎓 **USC Center for Systems and Software Engineering — COCOMO resources** (model
  definitions, calibration data, and tooling).
  <https://csse.usc.edu/tools/cocomoii/>
