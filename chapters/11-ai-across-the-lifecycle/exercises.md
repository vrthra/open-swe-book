...
2. **[warm‑up]** Name the five rungs of the "ladder of assistance" (§11.1.3). For each,
...
4. **[analysis]** The 2025 METR trial found experienced developers were ~19% *slower* with
   ...
   describe an experiment (using Chapter 10 methods) you could run on your own team to
   measure *your* real speedup instead of trusting the feeling.
5. **[analysis]** Pick any three lifecycle stages from §11.2. For each, write one sentence
   on what AI does well and one on the specific fundamental a human still owns. Cite the
   chapter each maps to.
6. **[analysis]** §11.2.6 says AI "inverts" the code‑review problem. Explain the inversion,
...
7. **[analysis]** The security evidence (§11.3) shows users of AI assistants writing *less*
