...
- 📄 **J. Dean & S. Ghemawat, "MapReduce: Simplified Data Processing on Large Clusters"**
  (OSDI 2004) — the original paper behind §7.4.4, widely available as a free PDF via
  university course pages (search "MapReduce Dean Ghemawat PDF"). *Free to read; © the
  authors/publisher.*
- 🎥 **Tyler Akidau — "The World Beyond Batch: Streaming"** (talk/companion articles) —
  ...
  §7.4.3. Search for the O'Reilly Radar articles "Streaming 101/102." *Free to read.*
...
- 📄 **Microsoft — Publisher-Subscriber, Gateway Aggregation, and Ambassador patterns**
  (within the Cloud Design Patterns catalog above) — concrete, documented instances of the
...
- 📄 **Carnegie Mellon Software Engineering Institute — Software Product Lines** —
  [sei.cmu.edu](https://www.sei.cmu.edu/our-work/software-product-lines/). Definitions of
...
- 📄 **M. Shaw & D. Garlan — architectural styles** — the academic origin of thinking about
  ...
  Overview papers and lecture notes are freely available via university course pages.
