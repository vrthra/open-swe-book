...
- 📄 **D. L. Parnas, "On the Criteria To Be Used in Decomposing Systems into Modules"**
  (1972) — the paper that introduced information hiding. Widely available as a PDF via
  university course pages; search the title. *License:* ACM copyright, *free to read* via
  many .edu mirrors.
...
- 📄 **ISO/IEC/IEEE 42010 — Architecture description** — the standard behind "views,"
  ...
  [iso-architecture.org/42010](https://www.iso-architecture.org/42010/). *License:* standard
  is paid; the overview page is *free to read*.
- 📘 **Software Architecture in Practice / SEI resources** — the Software Engineering
